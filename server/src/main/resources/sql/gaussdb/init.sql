...
CREATE TABLE c_ai_patient_memory (
    id_memory            VARCHAR(32) PRIMARY KEY,
    id_org               VARCHAR(32) NOT NULL,
    id_region            VARCHAR(32),
    id_his_org           VARCHAR(64) NOT NULL,
    patient_id           VARCHAR(128) NOT NULL,
    patient_name         VARCHAR(128),
    patient_gender       VARCHAR(16),
    patient_age          VARCHAR(32),
    patient_birth_date   VARCHAR(32),
    memory_version       NUMERIC(19) DEFAULT 0 NOT NULL,
    summary_json         TEXT,
    conflict_count       NUMERIC(10) DEFAULT 0 NOT NULL,
    quality_status       VARCHAR(16) DEFAULT 'partial' NOT NULL,
...
CREATE TABLE c_ai_patient_memory_obs (
    id_observation       VARCHAR(32) PRIMARY KEY,
    id_memory            VARCHAR(32) NOT NULL,
    id_device            VARCHAR(32),
    source_key           VARCHAR(256) NOT NULL,
    source_key_hash      VARCHAR(64) NOT NULL,
    source_type          VARCHAR(32) NOT NULL,
    source_version       VARCHAR(128),
    operation_code       VARCHAR(16) DEFAULT 'upsert' NOT NULL,
    payload_hash         VARCHAR(64) NOT NULL,
    visit_id             VARCHAR(128),
...
CREATE TABLE c_ai_patient_memory_fact (
    id_fact              VARCHAR(32) PRIMARY KEY,
    id_memory            VARCHAR(32) NOT NULL,
    fact_key             VARCHAR(256) NOT NULL,
    fact_key_hash        VARCHAR(64) NOT NULL,
    fact_type            VARCHAR(32) NOT NULL,
    fact_code            VARCHAR(128),
    fact_name            VARCHAR(256),
    value_text           VARCHAR(1000),
    fact_status          VARCHAR(32) DEFAULT 'historical' NOT NULL,
    confidence_level     VARCHAR(32) DEFAULT 'structured' NOT NULL,
    evidence_text        VARCHAR(1000),
    source_type          VARCHAR(32),
    source_key           VARCHAR(256),
    latest_observation_id VARCHAR(32),
    origin_code          VARCHAR(32) DEFAULT 'his' NOT NULL,
    fg_suppressed        CHAR(1) DEFAULT '0' NOT NULL,
    revision_no          NUMERIC(10) DEFAULT 1 NOT NULL,
...
CREATE TABLE c_ai_patient_memory_audit (
    id_audit             VARCHAR(32) PRIMARY KEY,
    id_memory            VARCHAR(32) NOT NULL,
    id_fact              VARCHAR(32),
    action_code          VARCHAR(32) NOT NULL,
    before_json          TEXT,
